...
/*
  ...
  // Function to update product details based on form input
  function updateProductDetails() {
      // Get values from the form
      const productName = document.getElementById('productName').value;
      const productDescription = document.getElementById('productDescription').value;
      const productCategories = document.getElementById('categories').value;
      ...
      document.getElementById('productCategories').innerText = productCategories;
      document.getElementById('productDescription').innerText = productDescription;
      document.getElementById('productLocation').innerText = productLocation;
  
      // Update the product image
      updateProductImage();
  
      // Additional logic to update other details like user info, etc., if needed
    }
    ...
    function updateProductImage() {
      ...
      // Set up the onload event to handle the selected image
      reader.onload = function (e) {
        // Set the source of the product image to the selected image
